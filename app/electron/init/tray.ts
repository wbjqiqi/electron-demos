...
import MainProcess from '../../main.development';
...
const createTray = (event: any) => {
    ...
    if (process.platform === 'darwin') {
                        ...
                        ? [
                            {
                                ...
                                click() {
                                    MainProcess.mainWindow.webContents.reload();
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                click() {
                                    // MainProcess.mainWindow.toggleDevTools();
                                },
                            },
                        ]
                        : [
        ...
        menu = Menu.buildFromTemplate(template);
        MainProcess.mainWindow.setMenu(menu);
    }

    tray.setToolTip('electron demo');
    tray.setContextMenu(menu);
    tray.on('click', event.onClick);
